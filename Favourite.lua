...
local function DYPZAW_fake_script() -- Bar.LocalScript 
	...
	while game:GetService("RunService").Heartbeat:wait() do
		...
		if n == 3 then
			...
			SetSize(Gain)
			SetColor(Gain)
			if (math.deg(Y) > LastY or UserInputService:IsKeyDown(Enum.KeyCode.A) == true) and UserInputService:IsKeyDown(Enum.KeyCode.D) == false then
				script.Parent.Left.Visible = true
				script.Parent.Right.Visible = false
			elseif (math.deg(Y) < LastY or UserInputService:IsKeyDown(Enum.KeyCode.D) == true) and UserInputService:IsKeyDown(Enum.KeyCode.A) == false then
...
coroutine.wrap(DYPZAW_fake_script)()
local function YIDSZMT_fake_script() -- Sync.LocalScript 
...
coroutine.wrap(YIDSZMT_fake_script)()
local function WTUR_fake_script() -- JHud.LocalScript 
...
coroutine.wrap(WTUR_fake_script)()
local function PZNV_fake_script() -- Record.LocalScript 
...
coroutine.wrap(PZNV_fake_script)()
